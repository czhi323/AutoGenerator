...
public class TestMainduorui {
	//基础信息
	public static final String PROJECT="manager-show";
	public static final String AUTHOR="czs";
	public static final String VERSION="V1.0";
	//数据库连接信息
	public static final String URL="jdbc:mysql://192.168.200.246:3306/duorui?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=GMT%2B8";
	public static final String NAME="root";
	public static final String PASSWORD="Wanglai@123456";
	public static final String DATABASE="duorui";
	//类信息
	...
	public static void main(String[] args) {
		...
		try {
			...
			String aa1=Generator.createEntity("E:\\duoruiGer\\", bi).toString();
			String aa2=Generator.createDao("E:\\duoruiGer\\", bi).toString();
			String aa3=Generator.createDaoImpl("E:\\duoruiGer\\", bi).toString();
			String aa4=Generator.createService("E:\\duoruiGer\\", bi).toString();
			String aa5=Generator.createServiceImpl("E:\\duoruiGer\\", bi).toString();
			String aa6=Generator.createController("E:\\duoruiGer\\", bi).toString();
